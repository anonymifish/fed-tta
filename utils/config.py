...
parser.add_argument('--task_name', type=str, default='debug_profile')
...
parser.add_argument('--global_rounds', type=int, default=3, help='total communication round')
...
# ---------- test --------
parser.add_argument('--model_name', type=str, default='model_round101.pt')
